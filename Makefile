...
FRONTEND_IMAGE ?= community-plugins-admin
BFF_IMAGE      ?= community-plugins-admin-bff
CHART_NAME     ?= community-plugins-admin-chart  # used by help display only; chart-package/chart-push use chart/ directly
VERSION        ?=
BUILDER        ?= podman
IMAGE_TAG      ?= latest
